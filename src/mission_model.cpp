...
bool MissionModel::read_json(std::string filename)
{
  ...
  try {
    ...
    boost::optional<boost::property_tree::ptree&> 
      agents_child = main_tree.get_child_optional("agents");
	...
	boost::optional<boost::property_tree::ptree&> 
	  safety_zone_child = agent.second.get_child_optional("safety_zone");	
	if(safety_zone_child) {
	  ...
	  std::cout << "[WARNING] No safety zone for agent" 
		    << agent.first << std::endl;
	}
    ...
    // --------------
    boost::optional<boost::property_tree::ptree&> 
      models_entry = main_tree.get_child_optional("models");
    ...
    boost::optional<boost::property_tree::ptree&> 
      wp_groups_child = main_tree.get_child_optional("wp_groups");
    ...
    if(wp_groups_child) {
      for(auto wp_group: wp_groups_child.get()) {
        ...
        a_group.color =  wp_group.second.get<string>("color", "green");
          ...
          // read waypoints
        boost::optional<boost::property_tree::ptree&> 
          waypoints_child = wp_group.second.get_child_optional("waypoints");
        ...
        // read patrols
        boost::optional<boost::property_tree::ptree&> 
          patrols_child = wp_group.second.get_child_optional("patrols");
    ...
    boost::optional<boost::property_tree::ptree&> 
      observations_entry = main_tree.get_child_optional("mission_goal.observation_points");
    ...
    // --------------------------------
    boost::optional<boost::property_tree::ptree&> 
      comms_entry = main_tree.get_child_optional("mission_goal.communication_goals");
